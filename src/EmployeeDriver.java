/*
hadoop jar jar_name.jar EmployeeDriver /hdfs_psth/Transactions.csv /output_dir
*/
...
public class EmployeeDriver extends Configured implements Tool{
		...
		public int run(String[] args) throws Exception {
			 ...
			 * Adding the file into cache i.e data node's main memory 
				provide your hdfs path
			 */
			DistributedCache.addCacheFile(new URI("/sample-data/Customers.csv"),config);
